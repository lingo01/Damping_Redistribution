...
DevTimeScaling = linspace(0.005, 2.5, 300);   
...
%%
figure(200);
subplot(4,2,3);     box on; hold on; grid on;
yyaxis left;
plot(DevTimeScaling, ratio_det', 'LineWidth', 1.2);  ylim([0,1])
title('(c)','FontSize',10,'FontName','Times New Roman');
xlabel('\gamma_{r,g}','FontSize',10,'FontName','Times New Roman');
